...
# loaded the latest model from model registry
...
def test_model_performance(model_pipe, test_data_path, threshold_error):
   ...
   assert mean_error <= threshold_error, f"The model does not pass the performance threshold_error {threshold_error}"
