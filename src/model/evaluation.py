...
# initialize dagshub
import dagshub
dagshub.init(repo_owner='guptatannu538', repo_name='food_delivery_swiggy_time_prediction', mlflow=True)
...
if __name__ == "__main__":
    ...
    with mlflow.start_run() as run:
        ...
        mlflow.sklearn.save_model(sk_model=model, path=model_save_path, signature=model_signature, serialization_format="cloudpickle",skops_trusted_types=trusted_types,)
